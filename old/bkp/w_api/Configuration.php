...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '073fdda85ee80fb0ef7c28611f6876cf7140db8775475a4528c02ecaedecc905';
	const ERROR_REPORTING_LEVEL = 0;
	const DEPLOYED_HOSTNAME = 'irriagro.com.br';
	const BUILDDATE = 1502195493;
